...
export const people = [];
export const livesInLinks = [];
export const worksAtLinks = [];
export const memberOfLinks = [];
export const hasInterestLinks = [];
export const hasSkillLinks = [];
export const knowsLinks = [];
...
for (let i = 1; i <= 120; i++) {
    ...
    for (const interest of chosenInterests) {
        ...
        if (pNode)
            pNode.interests.push(interest.name);
    }
    // Skills
